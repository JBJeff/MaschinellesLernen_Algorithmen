# -*- coding: utf-8 -*-
"""
Created on Tue Feb  6 17:20:38 2024
...
# Random Forest Regression erstellen und trainieren: erläuterung der weiteren Kompenten sind in der Ausarbeitung
...
# Vorhersagen mit Random Forest Regression
x_test = []
...
plt.plot(test_dates, predicted_prices, color="blue", label=f"Prognosierter {company} Preis (Random Forest)")
